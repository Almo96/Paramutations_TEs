...
df<-read.table("/Users/ascarpa/Paramutations_TEs/Simulation/Raw/2023_05_12_Supplement_recombination", fill = TRUE, sep = "\t")
...
``` r
df_new<-read.table("/Users/ascarpa/Paramutations_TEs/Simulation/Raw/2022_12_10_Simulation_10_Clusters_removal_3000_new", fill = TRUE, sep = "\t")
...
![](2023_05_12_Supplement_Addendum_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
In the case of 5 cluster removed, if no paramutations are present TEs
can’t be stopped, in the paramutations case 84% of the invasions are
stopped.
